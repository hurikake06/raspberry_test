...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { end_time: @share.end_time, pet_id: @share.pet_id, start_time: @share.start_time, user_id: @share.user_id } }
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { end_time: @share.end_time, pet_id: @share.pet_id, start_time: @share.start_time, user_id: @share.user_id } }
